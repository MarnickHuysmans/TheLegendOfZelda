...
#pragma region CollisionFunctionality
	...
	bool IsOverlapping(const std::vector<Point2f>& vertices, const Rectf& r1);
...
#pragma region FileReading
	...
	Vector2f GetLocation(const std::string& str);
	std::string Trim(const std::string& str, const std::string& chars = "\t\n\v\f\r ");
	Rectf GetBoundaries(const std::string& str);
	bool GetBool(const std::string& str);
	Direction GetDirection(const std::string& str);
	Rupee::Color GetRupeeColor(const std::string& str);
